module github.com/gcottom/aegisx
...
require (
	github.com/gcottom/qgin v0.0.10
...
require (
	...
	github.com/gcottom/audiometa/v3 v3.0.4 // indirect
	github.com/gcottom/flacmeta v0.0.6 // indirect
	github.com/gcottom/go-zaplog v0.0.3 // indirect
